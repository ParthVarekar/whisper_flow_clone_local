...
def build_prompt(mode: str, transcript: str, *,
    ...
    system += (
        ...
        "- Avoid Unrequested Styling: Do NOT apply bold (**), italics (*), or underline (<u>) to any words or phrases unless the user explicitly dictated a formatting command (like 'bold [word]'). Never arbitrarily add bold or italics for emphasis.\n"
